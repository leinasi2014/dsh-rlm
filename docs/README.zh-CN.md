...
1. [项目状态](project-status.zh-CN.md)：目标、已完成里程碑、未完成工作与发布基线。
2. [核心架构](architecture.zh-CN.md)：一个工具、一个 Session Python kernel、一个
   one-shot query 回调，以及 RLM/自我迭代闭环。
3. [审查结论](review-findings.zh-CN.md)：实现、算法、架构与两个参考实现的复核结果。
4. [里程碑](milestones.zh-CN.md)：M1 可运行闭环、M2 本地可靠性和条件里程碑。
